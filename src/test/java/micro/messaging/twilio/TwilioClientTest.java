...
class TwilioClientTest {
  ...
  void send_request_to_twilio() throws IOException, InterruptedException {
    ...
    assertThat(recordedRequest.getPath())
        .isEqualTo("/2010-04-01/Accounts/anyAccountSid/Messages.json");
